...
class TestRickyLayoutGenerator < Test::Unit::TestCase
  ...
  context "generator with haml option" do
    rails_generator :ricky_layout, "foobar", :haml => true
